CLIWrapper
==========
[![Build Status](http://jenkins.ahelper.me/buildStatus/icon?job=tests)](http://jenkins.ahelper.me/job/tests/master) [![NPM Version](https://www.npmjs.com/package/cliwrapper)](https://img.shields.io/npm/v/npm.svg)
